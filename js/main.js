...
var GameState = {
  ...
  create: function() {
    ...
    //group for animals
    var animalData = [
      {key: 'chicken', text: 'תרנגול', audio: 'chickenSound'},
      {key: 'horse', text: 'סוס', audio: 'horseSound'},
      {key: 'pig', text: 'חזיר', audio: 'pigSound'},
      {key: 'sheep', text: 'כבשה', audio: 'sheepSound'}
    ];
  ...
  showText: function(animal) {
    ...
    if(!this.animalText) {
      var style = {font: " 40pt Miriam", fill: "blue", align: "center"};
